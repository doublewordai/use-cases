...
We used the [Wikimedia Wikipedia dataset](https://huggingface.co/datasets/wikimedia/wikipedia) from HuggingFace, the first paragraph of every English Wikipedia article (November 2023 dump). The dataset is freely available with no API key required.
