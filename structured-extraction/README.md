...
We ran the GPT models via OpenAI's real-time API (their batch API doesn't support fast-turnaround batches or partial result downloads). For a fair cost comparison, we quote OpenAI's batch pricing throughout.
